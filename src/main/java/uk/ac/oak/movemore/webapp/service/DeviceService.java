...
public interface DeviceService {
	...
	JSONResponse updateDeviceLocation(
			...
			@ApiParam(value = "Device current latitude", allowableValues = "range[1,13]", required = true) @PathParam("latitude") Float latitude,
			@ApiParam(value = "Device current longitude", allowableValues = "range[1,13]", required = true) @PathParam("longitude") Float longitude);
	...
	@Produces(MediaType.APPLICATION_JSON)
	JSONResponse registerNewDevice(
			...
			@ApiParam(value = "Device current latitude", allowableValues = "range[1,13]", required = true) @PathParam("latitude") Float latitude,
			@ApiParam(value = "Device current longitude", allowableValues = "range[1,13]", required = true) @PathParam("lonitude") Float longitude,
	...
	@CrossOriginResourceSharing(allowAllOrigins = true)
	@Produces(MediaType.APPLICATION_JSON)
	public JSONResponse registerOrUpdateDeviceInfo(
